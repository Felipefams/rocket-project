...
export class CreateRocket1681936141147 implements MigrationInterface {
    name = 'CreateRocket1681936141147'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "launch" ("id" SERIAL NOT NULL, "launchCode" integer NOT NULL, "date" character varying NOT NULL, "success" boolean NOT NULL, "rocket_id" integer, "crew_id" integer, CONSTRAINT "REL_968817f025629bca18fe3f56bb" UNIQUE ("rocket_id"), CONSTRAINT "REL_3913e7efe32c3b5394fdcb7379" UNIQUE ("crew_id"), CONSTRAINT "PK_0efd83695074312cab129ff59f0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "crew_crewman" ("crewmanId" integer NOT NULL, "crewId" integer NOT NULL, CONSTRAINT "PK_72f5b4c0b353f409d8088ee7835" PRIMARY KEY ("crewmanId", "crewId"))`);
